				...
				<li class="panel ">
                    ...
                    <ul class="collapse" id="pembayaran-nav">  
                        ...
                        <li class=""><a href="index.php?m=contents&p=listdatapetugas"><i class="icon-angle-right"></i> Lihat Data BPH </a></li>
                    </ul>
                </li>				
		        ...
		        <li class="panel ">   
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#user-nav">
                        <i class="icon-group"> </i> Data Anggota   
                    ...
                    <ul class="collapse" id="user-nav">  
                        ...
                        <li class=""><a href="index.php?m=contents&p=listdatauser"><i class="icon-angle-right"></i> List Data Anggota </a></li>
                    </ul>
                </li>
