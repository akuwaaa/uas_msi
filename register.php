	...
	<div class="agileits-top">
        <form action="" method="POST">
			...
			<div class="form-group">
                ...
                <input class="form-control" type="text" name="bank_user" placeholder="Fakultas" required />
            </div>
			
			<div class="form-group">
                <label for="rekening"></label>
                <input class="form-control" type="text" name="rekening_user" onkeypress="return hanyaAngka(event, false)" placeholder="NIM" required />
            </div>
