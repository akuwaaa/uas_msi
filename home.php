...
<html>
    <head>
        ...
        <title>Selamat Datang - UKM</title>
        ...
        <div class="page-content">
            <section id="featured" class="content-section">
                <div class="section-heading">
                    <h1><!--<php echo $_SESSION['username'];?>,--> Agenda Kegiatan<br><em>UKM Unsri</em></h1>
                    <p>Berikut adalah agenda kegiatan yang akan dilaksanakan
                    <br>oleh UKM Unsri Kedepannya.</p>
                </div>
			...
			<section id="datakeuangan" class="content-section">
                <div class="section-heading">
                    <h1>Data Keuangan<br><em>UKM Unsri</em></h1>
                    <p>Berikut data keuangan dari
                    <br>UKM Unsri.</p>
				<div>
				<br>
				</div>
						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									Data uang yang masuk ke kas UKM Unsri
								</div>
			...
			<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									Data uang yang keluar dari kas UKM
								</div>
			...
			<section id="donate" class="content-section">
                <div class="section-heading">
                    <h1>Pengajuan<br><em>Kegiatan</em></h1>
                    <p>Silahkan ajukan kegiatan UKM dengan
                    <br>mengisi form berikut</p>
                </div>
					...
					<form action="tambah-transfer.php" method="POST" enctype="multipart/form-data">
						<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr height="46">
								<td width="10%"> </td>
								<td width="25%"> </td>
								<td width="65%"><font size="4"><b>Form Pengajuan Kegiatan</b></font></td>
							</tr>
							<tr height="46">
								<td> </td>
								<td>ID Kegiatan</td>
							...
							<tr height="46">
								<td> </td>
								<td>Jumlah Waktu Kegiatan (Hari)</td>
								<td>
								<input type="text" name="nominal" onkeypress="return hanyaAngka(event, true)" class="form-control"  required />								
								</td>
							</tr>
							<tr height="50">
							<td> <br> </td>
			...
			<section id="contact" class="content-section">
                <div class="section-heading">
                    ...
                    <p>Kami siap membantu Anda dalam mendapatkan informasi, layanan, dan koordinasi 
                    <br>terkait seluruh kegiatan UKM Universitas Sriwijaya.</p>
                </div>
                <div style="border:0; padding:10px; width:760px; height:auto; text-align:left;">
